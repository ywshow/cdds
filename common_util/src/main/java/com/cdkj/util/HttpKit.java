...
//        httpget.releaseConnection();
     ...
     * Send POST request
     */
    public static String request(String url, Map<String, String> queryParas, String data, Map<String, String> headers, String method) {
        HttpURLConnection conn = null;
        OutputStream out = null;
        try {
            conn = getHttpConnection(buildUrlWithQueryString(url, queryParas), method, headers);
            conn.connect();
    ...
    public static String request(String url, Map<String, String> queryParas, String data, String method) {
        return request(url, queryParas, data, null, method);
    }

    public static String request(String url, String data, Map<String, String> headers, String method) {
        return request(url, null, data, headers, method);
    }

    public static String request(String url, String data, String method) {
        return request(url, null, data, null, method);
    }
