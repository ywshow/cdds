...
public class UUIDGenerator {
    ...
    public Serializable generate() {
        return new StringBuffer(40).append(format(getIP())).append(sep).append(format(getJVM())).append(sep).append(format(getHiTime())).append(sep).append(format(getLoTime())).append(sep)
