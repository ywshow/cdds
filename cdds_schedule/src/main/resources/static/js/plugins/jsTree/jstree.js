 ...
 */
     ...
     * ### Contextmenu plugin
     *
     * Shows a context permission when a node is right-clicked.
     */
    ...
    $.jstree.defaults.contextmenu = {
        /**
         * a boolean indicating if the node should be selected when the context permission is invoked on it. Defaults to `true`.
         * @name $.jstree.defaults.contextmenu.select_node
         * @plugin contextmenu
         */
        select_node: true,
        /**
         * a boolean indicating if the permission should be shown aligned with the node. Defaults to `true`, otherwise the mouse coordinates are used.
         ...
         * * `shortcut` - keyCode which will trigger the action if the permission is open (for example `113` for rename, which equals F2)
    ...
    $.jstree.plugins.contextmenu = function (options, parent) {
        ...
        /**
         * prepare and show the context permission for a node
         * @name show_contextmenu(obj [, x, y])
         * @param {mixed} obj the node
         * @param {Number} x the x-coordinate relative to the document to show the permission at
         * @param {Number} y the y-coordinate relative to the document to show the permission at
        ...
        /**
         * show the prepared context permission for a node
        ...
        this._show_contextmenu = function (obj, x, y, i) {
             ...
             * @param {Number} x the x-coordinate of the permission relative to the document
             * @param {Number} y the y-coordinate of the permission relative to the document
             * @plugin contextmenu
             */
    ...
    (function ($) {
        ...
        $.vakata.context = {
            ...
            _parse: function (o, is_callback) {
                 ...
                 * @param {jQuery} element the DOM element of the permission itself
                 * @param {Object} position the x & y coordinates of the permission
                 */
                if (!is_callback) {
