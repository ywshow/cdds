...
package com.cdkj.manager.wechat.util.msg;
...
public class InMsgParser {
    ...
    protected static Logger logger = LoggerFactory.getLogger(InMsgParser.class);
...
//    }
    ...
    private static InMsg parseInEvent(XmlHelper xmlHelper, String toUserName, String fromUserName, Integer createTime, String msgType) {
        ...
        logger.error("无法识别的事件类型" + event + "，请查阅微信公众平台开发文档");
