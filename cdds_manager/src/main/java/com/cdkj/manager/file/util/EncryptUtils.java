/**
 * project name:api
 * file name:EncryptUtils
 * package name:com.vellgo.common
 * date:2017-01-20 14:32
 * author:kola
 * Copyright (c) CD Technology Co.,Ltd. All rights reserved.
 */
package com.cdkj.manager.file.util;
...
public class EncryptUtils {
     ...
     * 密钥
     */
    private static final String KEY = "4lbPsWp5FqFbSjES";
    ...
    public static void main(String[] args) throws Exception {
        String content = "fandian&123456";
        System.out.println("加密前：" + content);

        System.out.println("加密密钥和解密密钥：" + KEY);

        String encrypt = aesEncrypt(content, KEY);
        System.out.println(MD5.md5(encrypt));
